...
export const Route = createFileRoute("/docs")({
  component: Docs,
  head: () => ({ meta: [
    { title: "Docs — StargazeMPP" },
    { name: "description", content: "StargazeMPP developer documentation: x402 vouchers, EIP-712 signing, dual rails, reputation, and provider onboarding." },
  ] }),
});
      ...
      <header className="sticky top-0 z-30 backdrop-blur-md border-b" style={{ borderColor: "rgba(196,179,236,0.16)", background: "rgba(26,21,48,0.72)" }}>
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-12 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 text-sm">
            <Link to="/" className="text-[#a89fc7] hover:text-[#ebe6f7]">Home</Link>
...
await session.close();`}
          ...
          <section id="errors" className="d-anchor">
            ...
            <p className="d-p mt-8">Have a question we haven't answered? <Link to="/dashboard" className="d-link link-line">Open the playground →</Link></p>
          </section>
